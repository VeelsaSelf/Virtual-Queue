          ...
          <div style={{ marginBottom: '2rem' }}>
                      ...
                      {PAYMENT_METHODS.map(method => (
                        <button
                          ...
                          onMouseLeave={(e) => {
                            ...
                            e.target.style.color = paymentMethod === method.id ? COLORS.tanAccent : COLORS.white;
                          }}
                        >
                          {method.label}
                        </button>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              <input
                ...
                onBlur={(e) => {
                  e.target.style.borderColor = `${COLORS.tanAccent}40`;
                  e.target.style.backgroundColor = COLORS.darkBg;
                }}
              />
            </div>
        ...
        <div style={{
          ...
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.target.style.boxShadow = `0 10px 25px rgba(212, 175, 154, 0.3)`;
            }}
            onMouseLeave={(e) => {
